...
const Search = () => {
  ...
  return (
    <OutsideClickWrapper onClickOutside={() => setShowResult(false)}>
      <div className="relative flex items-center justify-between px-4 py-3 rounded-full w-full bg-bgColor">
        {/* the in put search */}
        <div className="flex items-center w-full">
          <AiOutlineSearch className="" fontSize={24} />
          <input
            type="text"
            className="outline-none ml-1.5 w-full text-lg bg-bgColor pr-1.5"
            alt=""
            value={searchValue}
